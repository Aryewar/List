...
namespace List.Tests
{
    public abstract class BaseTest
    {
        ...
        public void Add_WhenListPassed_ThenAddListInLast(int[] actualArray, int[] arrayForList, int[] expectedArray)
        {
            Init(actualArray, expectedArray);
        ...
        public void Remove_WhenMethodCalled_ThenRemove(int[] actualArray, int[] expectedArray)
        {
            Init(actualArray, expectedArray);
            _actual.Remove();
        ...
        [TestCase(new int[] { }, 0, new int[] { })]
        public void Remove_WhenCountPassed_ThenRemove(int[] actualArray, int count, int[] expectedArray)
        {
            Init(actualArray, expectedArray);

            _actual.Remove(count);
        ...
        public void GetMaxIndex_WhenMethodCalled_ThenReturnMaxIndex(int[] actualArray, int expected)
        {
            ...
            int actual = _actual.GetMaxIndex();
        ...
        public void GetMinIndex_WhenMethodCalled_ThenReturnMinIndex(int[] actualArray, int expected)
        {
            ...
            int actual = _actual.GetMinIndex();
        ...
        [TestCase(new int[] { })]
        [TestCase(null)]
        public void GetMinIndex_WhenNullOrListIsEmptyPassed_ThenReturnArgumentException(int[] actualArray)
        {
            Assert.Throws<ArgumentException>(() =>
            {
                Init(actualArray);
        ...
        public void GetMaxElement_WhenMethodCalled_ThenReturnMaxElement(int[] actualArray, int expected)
        {
            ...
            int actual = _actual.GetMaxElement();
        ...
        [TestCase(new int[] { })]
        [TestCase(null)]
        public void GetMaxElement_WhenNoElementsInCollection_ThenReturnArgumentException(int[] actualArray)
        {
            Assert.Throws<ArgumentException>(() =>
            {
                Init(actualArray);
        ...
        public void GetMinElement_WhenMethodCalled_ThenReturnMinElement(int[] actualArray, int expected)
        {
            ...
            int actual = _actual.GetMinElement();
        ...
        [TestCase(new int[] { })]
        [TestCase(null)]
        public void GetMinElement_WhenNoElementsInCollection_ThenReturnArgumentException(int[] actualArray)
        {
            Assert.Throws<ArgumentException>(() =>
            {
                Init(actualArray);
